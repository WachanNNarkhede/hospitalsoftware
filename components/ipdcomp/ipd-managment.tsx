...
import IpdPatientDetailModal from "@/components/ipdcomp/ipd-patient-detail-modal"
import DischargedPatientsModal from "@/components/ipdcomp/discharged-patient-modal"
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex space-x-3">
            <Button
              ...
              variant="outline"
              className="flex items-center space-x-2 cursor-pointer  hover:bg-gray-200/40"
            >
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 cursor-pointer text-white flex items-center space-x-2"
            >
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 cursor-pointer p-2 hover:bg-blue-300/50"
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 cursor-pointer p-2 hover:bg-gray-300/50"
                        onClick={() => handleAddPrescription(patient)}
                        title="Add Prescription"
                      >
                        <Pill className="w-4 h-4" />
                      </Button>
                      <Button variant="ghost" size="icon" className="h-8 w-8 cursor-pointer p-2 hover:bg-gray-300/50" title="Edit">
                        <Edit className="w-4 h-4" />
                      </Button>
                      <Button
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 text-red-600 hover:text-red-700  hover:bg-red-500/40 cursor-pointer p-2 "
                        title="Discharge"
                      >
                        <UserMinus className="w-4 h-4" />
                      </Button>
