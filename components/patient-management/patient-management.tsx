...
export default function PatientManagement({  onSearch, setSelectedPatient }: PatientManagementProps) {
          ...
          <div className="absolute z-20 mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg max-h-60 overflow-y-auto">
            {searchResults.length > 0 ? (
              ...
              <div className="p-4 text-center text-gray-500">
                ...
                <Button onClick={handleAddNewPatient} variant="outline" className="mt-2">
                  Add New Patient
                </Button>
              </div>
            )}
