              ...
              <div>
                ...
                <Select value={appointmentType} onValueChange={setAppointmentType}>
                  ...
                  <SelectContent className="bg-blue-700 text-white ">
                    <SelectItem className="hover:bg-green-700" value="checkup">Regular Checkup</SelectItem>
                    <SelectItem className="hover:bg-green-700"value="consultation">Consultation</SelectItem>
                    <SelectItem className="hover:bg-green-700" value="followup">Follow-up</SelectItem>
                    <SelectItem className="hover:bg-green-700" value="emergency">Emergency</SelectItem>
                  </SelectContent>
                </Select>
              </div>
