...
// This code defines a settings page for a healthcare application, allowing users to manage their profile, hospital information, and notification preferences. It includes a sidebar for navigation and a form for updating settings.
// The page is structured with a dashboard layout, a page header, and a content wrapper. It uses various UI components like buttons, inputs, labels, and textareas to create a user-friendly interface. Icons from the Lucide React library are used for visual enhancement.    